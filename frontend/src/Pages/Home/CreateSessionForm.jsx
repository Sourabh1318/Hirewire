...
const CreateSessionForm = () => {
  ...
  const handleCreateSession = async (e) => {
    ...
    try {
      ...
      console.log("Response Sessioon Create Form  : ", response);
  ...
  return (
    <div className="w-[90vw] md:w-[55vw] p-7 flex flex-col justify-center">
      <h3 className="text-lg font-semibold  text-black">
        Start a New Interview Prep Journey
      </h3>
      <p className="text-xs text-slate-700 mt-[5px] mb-3 ">
        Please fill out the a few quick detailsand unlock your personalized set
      ...
      <form onSubmit={handleCreateSession} className="flex flex-col gap-4">
        ...
        <Input
          ...
          placeholder="e.g., Comma Seperated React.js, Node.js"
          type="text"
        />
        ...
        <Input
          ...
          label="Description"
          placeholder="Any Specific Notes or goals for this session"
          type="text"
        />
